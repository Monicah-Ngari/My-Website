            ...
            <ul>
              <li>
                <div className="project-item">
                  ...
                  <p>
                    <strong>Technologies Used:</strong> React, CSS, RESTful
                    APIs.
                  </p>
                  <p>
              ...
              <li>
                <div className="project-item">
                  ...
                  <p>
                    <strong>Description:</strong> Created a responsive and
                    dynamic music website with Bootstrap and JavaScript.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Impact:</strong> Increased online free music
                    download
                  </p>
                </div>
              </li>
              <li>
                <div className="project-item">
                  ...
                  <p>
                    <strong>Description:</strong> Created a responsive and
                    dynamic personal landing page with Bootstrap and JavaScript.
                  </p>
                  <p>
                    <strong>Technologies Used:</strong> HTML, CSS, JavaScript,
                    Bootstrap.
